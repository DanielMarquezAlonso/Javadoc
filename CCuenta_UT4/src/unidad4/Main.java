...
/**
 * Muestra por pantalla dependiendo de los parametros 
 * que escribimos
 * @param cuenta1 variable que contiene el dinero de la cuenta bancaria
 * @param cantidad variable que sirve para retirar o ingresar dinero a la cuenta
 * @param opcion variable que muestra una acción dependiendo de la opcion elegida
 */
